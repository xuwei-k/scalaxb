...
object Dependencies {
  ...
  def dispatch(sv: String) = "org.dispatchhttp" %% "dispatch-core" % "1.2.0" cross CrossVersion.for3Use2_13
  ...
  val defaultGigahorseVersion = "0.7.0"
  ...
  def specs2(sv: String) = CrossVersion partialVersion sv match {
    ...
    case _             => "org.specs2" %% "specs2-matcher-extra" % "4.20.2"
  }
